...
static const uint256 hashGenesisBlock("0x000006a6f30fee3a9ad207e6b5cc8b91e6dcc54ca01237a2444667fd34f9f53b");
static const uint256 hashGenesisBlockTestNet("0x000006a6f30fee3a9ad207e6b5cc8b91e6dcc54ca01237a2444667fd34f9f53b");
...
public:
    ...
    {
        // RoundCoin: the coin stake transaction is marked with the first output empty
    ...
    */
    ...
    bool GetCoinAge(CTxDB& txdb, uint64_t& nCoinAge) const;  // RoundCoin: get transaction coin age
...
public:
    ...
    // RoundCoin: block signature - signed by one of the coin base txout[N]'s owner
    ...
    // RoundCoin: two types of block: proof-of-work or proof-of-stake
    ...
    // RoundCoin: get max transaction timestamp
    ...
    bool AcceptBlock();
    bool GetCoinAge(uint64_t& nCoinAge) const; // RoundCoin: calculate total coin age spent in block
...
public:
    ...
    unsigned int nFile;
    unsigned int nBlockPos;
    uint256 nChainTrust; // RoundCoin: trust score of block chain
    int nHeight;

    int64_t nMint;
    int64_t nMoneySupply;

    unsigned int nFlags;  // RoundCoin: block index flags
    enum  
    {
